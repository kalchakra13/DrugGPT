...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='coco', choices=['coco', 'msrvtt', 'vatex', 'flickr30k_de', 'flickr30k_fr'])
...
'''
python loop_evaluate.py --from_pretrained output/adapt/vit-b-16_coco_CA_n1_p0_0.10 --folder coco_subsets/0% --dataset coco --pickle
python loop_evaluate.py --from_pretrained output/adapt/vit-b-16_coco_CA_n1_p0_0.10 --folder msrvtt_subsets/0% --dataset msrvtt --pickle
'''
