    ...
    if args.evaluate:
        ...
        for mode, loader in zip(modes, loaders):
            ...
            if not args.no_score:
                if args.dataset not in ['msrvtt_bi', 'vatex'] and config.get('eval_lang', configs.main_lang) == 'zh':
                    pass
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='coco', choices=['coco', 'msrvtt', 'vatex', 'flickr30k', 'msrvtt_bi', 'coco_subset', 'flickr30k_de', 'flickr30k_fr'])
    ...
    parser.add_argument('--keys_to_override', nargs='+', default=[
        ...
        'pickle_path', 'noise_std', 'num_hidden_layers', 'prompt_length', 'label_smoothing', 'num_tokens',
        'num_beams', 'freeze_decoder', 'freeze_projector', 'average_pooling',
    ])
...
'''
python3 -m torch.distributed.launch --nproc_per_node=4 --use_env finetune.py --from_pretrained output/adapt/vit-b-16_cc3m_n0_p1 --folder zero_shot --evaluate
python3 -m torch.distributed.launch --nproc_per_node=4 --use_env finetune.py --clip_arch ViT-B/16 --method n0_p1 --output_dir output/finetune/vit-b-16_n0_p1
python3 -m torch.distributed.launch --nproc_per_node=4 --use_env finetune.py --clip_arch ViT-B/16 --method n1_p1 --output_dir output/finetune/vit-b-16_n1_p1
python3 -m torch.distributed.launch --nproc_per_node=4 --use_env finetune.py --clip_arch ViT-B/16 --method n1_p1 --output_dir output/finetune/unfreeze_vit-b-16_n1_p1 --config configs/finetune2.yaml

python3 finetune.py -mode finetune -arch ViT-B/16 -ipp data/corpus/coco_image_vit-b-16.pkl -bsz 128 -method n1_p1 --output_dir output/finetune/baseline_vit-b-16
python3 finetune.py --from_pretrained output/finetune/baseline_vit-b-16 --folder eval --evaluate --ckpt_name checkpoint_best.pth

python3 finetune.py -mode adapt -arch ViT-B/16 -dp data/corpus/coco_vit-b-16.pkl -bsz 128 -method n1_p1 -std 0.00 --output_dir output/unsupervised/vit-b-16_coco_n1_p1_0.00
python3 finetune.py -mode adapt -arch ViT-B/16 -dp data/corpus/coco_vit-b-16.pkl -bsz 128 -method n1_p1 -std 0.10 --output_dir output/unsupervised/vit-b-16_coco_n1_p1_0.10
python3 finetune.py -mode adapt -arch ViT-B/16 -dp data/corpus/coco_vit-b-16.pkl -bsz 128 -method n1_p1 -std 0.20 --output_dir output/unsupervised/vit-b-16_coco_n1_p1_0.20

python3 finetune.py -mode adapt -arch ViT-B/16 -dp data/corpus/coco_vit-b-16.pkl -bsz 128 -method n1_p4_soft -std 0.10 --output_dir output/unsupervised/vit-b-16_coco_n1_p4_soft_0.10
python3 finetune.py -mode adapt -arch ViT-B/16 -dp data/corpus/coco_vit-b-16.pkl -bsz 128 -method n1_p4_prefix -std 0.10 --output_dir output/unsupervised/vit-b-16_coco_n1_p4_prefix_0.10
python3 finetune.py -mode adapt -arch ViT-B/16 -dp data/corpus/coco_vit-b-16.pkl -bsz 128 -method n1_p4_soft --output_dir output/unsupervised/vit-b-16_coco_n1_p4_soft
python3 finetune.py -mode adapt -arch ViT-B/16 -dp data/corpus/coco_vit-b-16.pkl -bsz 128 -method n1_p4_prefix --output_dir output/unsupervised/vit-b-16_coco_n1_p4_prefix

python3 finetune.py -mode finetune -arch ViT-L/14 -ipp data/corpus/coco_image_vit-l-14.pkl -bsz 128 -method n1_p1 --output_dir output/finetune/baseline_vit-l-14
python3 finetune.py -mode adapt -arch ViT-L/14 -dp data/corpus/coco_vit-l-14.pkl -bsz 128 -method n1_p1 -std 0.10 --output_dir output/unsupervised/vit-l-14_coco_n1_p1_0.10
python3 finetune.py -mode adapt -arch ViT-L/14 -dp data/corpus/coco_vit-l-14.pkl -bsz 128 -method n1_p4_soft -std 0.10 --output_dir output/unsupervised/vit-l-14_coco_n1_p4_soft_0.10
python3 finetune.py -mode adapt -arch ViT-L/14 -dp data/corpus/coco_vit-l-14.pkl -bsz 128 -method n1_p4_prefix -std 0.10 --output_dir output/unsupervised/vit-l-14_coco_n1_p4_prefix_0.10
python3 finetune.py -mode adapt -arch ViT-L/14 -dp data/corpus/coco_vit-l-14.pkl -bsz 128 -method n1_p4_soft --output_dir output/unsupervised/vit-l-14_coco_n1_p4_soft
python3 finetune.py -mode adapt -arch ViT-L/14 -dp data/corpus/coco_vit-l-14.pkl -bsz 128 -method n1_p4_prefix --output_dir output/unsupervised/vit-l-14_coco_n1_p4_prefix

python3 finetune.py -mode adapt -arch ViT-B/16 -dp data/corpus/coco_vit-b-16.pkl -bsz 128 -method n1_p1 -std 0.10 --output_dir output/vit-b-16/p1_noise01 && bash scripts/ablate_fewshot.sh output/vit-b-16/p1_noise01
python3 finetune.py -mode adapt -arch ViT-B/16 -dp data/corpus/coco_vit-b-16.pkl -bsz 128 -method n1_p1 -std 0.00 --output_dir output/vit-b-16/p1_noise00 && bash scripts/ablate_fewshot.sh output/vit-b-16/p1_noise00
python3 finetune.py -mode adapt -arch ViT-B/16 -dp data/corpus/coco_vit-b-16.pkl -bsz 128 -method n1_p4_prefix -std 0.10 --output_dir output/vit-b-16/p4_noise01 && bash scripts/ablate_fewshot.sh output/vit-b-16/p4_noise01
python3 finetune.py -mode adapt -arch ViT-B/16 -dp data/corpus/coco_vit-b-16.pkl -bsz 128 -method n1_p4_prefix -std 0.00 --output_dir output/vit-b-16/p4_noise00 && bash scripts/ablate_fewshot.sh output/vit-b-16/p4_noise00

python3 finetune.py -ipp data/corpus/coco_image_vit-b-16.pkl -bsz 128 -method CA_n1_p0 --output_dir output/baseline/vit-b-16_coco_CA_n1_p0
'''
